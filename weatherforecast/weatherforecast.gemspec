...
require 'weatherforecast/api'
require 'weatherforecast/test'

Gem::Specification.new do |spec|
  spec.name          = "weatherforecast"
  spec.version       = Weatherforecast::VERSION
  spec.authors       = ["Mariah Schneeberger"]
  spec.email         = ["mariah.acacia@gmail.com"]

  spec.summary       = "Wrapper for openweathermap api"
  spec.description   = "Wrapper for openweathermap api"
